...
view.agk = Views(agkaln, names = "Agkistrodon_piscivorus")
...
view.amp = Views(ampanl, name = "Amphisbaena_schmidit_voucher")
...
view.arc = Views(arcaln, name = "Acrochordus_granulatus")
...
view.boa= Views(boaaln, names = "Boa_constrictor")
...
view.cyl = Views(cylaln, name = "Cylindrophis_ruffus")
...
view.did = Views(didaln, name = "Dinodon_semicarinatus")
...
view.enh = Views(enhaln, names = "Enhydris_plumbea")
...
view.igu = Views(igualn, names = "Iguana_iguana")
...
view.naja = Views(najaaln, names = "Naja_naja")
...
view.ovo = Views(ovoaln, names = "Ovophis_okinavensis")
...
view.pan = Views(panaln, names = "Pantherophis_slowinskii")
...
view.ple = Views(plealn, names = "Plestiodon_egregius")
...
view.pyt = Views(pytaln, names = "Python_regius")
...
view.ram = Views(ramaln, names = "Ramphotyphlops_braminus")
...
view.ren = Views(renaln, names = "Rena_humilis")
...
view.xen = Views(xenaln, names = "Xenopeltis_unicolor")
